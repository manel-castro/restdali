...
router.get(
  ...
  async function (req: Request, res: Response, next: NextFunction) {
    ...
    const favicon = existingProject?.generalPageContent.favicon;
    const pageTitle = existingProject?.generalPageContent.pageTitle;
    const paginasOrder = existingProject?.paginasOrder;
    const languagesForTranslation = existingProject?.languagesForTranslation;
    const id = existingProject?.id;

    const pages = existingProject?.paginas;
